...
import GameBoard, { getXYFromIndex } from './GameBoard';
...
class HexicographyGame extends React.Component {
  ...
  render() {
    return (
      <div className="wrapper">
        ...
        <div className="hexicographyGame">
          <GameBoard
...
export default HexicographyGame;
